...
def convert_to_id(key, value):
    ...
    for i, element in enumerate(data):
        ...
        # Key is only contains 3 data points
        if i == 4:
            break
...
def main():
    ...
    sample_bom_path = f"{sub_directory}/donor_bom.csv"
    ...
    for name in project_names:
        ...
        bom_path = f"{sub_directory}/{name}.csv"
    ...
    # Write master bom
    output_master_bom_path = sample_bom_path 
